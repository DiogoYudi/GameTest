    ...
    public void dropItem(Entity droppedItem){
        for(int i = 0; i < gp.obj.length; i++){
            ...
            if(gp.obj[i] == null){
                ...
                gp.obj[i].worldX = worldX;      //Local que o monstro morreu
        ...
        if(worldX + gp.titleSize > gp.player.worldX - gp.player.screenX && //Essa condição é para que o while não gere os blocos que estão fora da range do player
            ...
            worldY - gp.titleSize< gp.player.worldY + gp.player.screenY){
                ...
                if(type == 2 && hpBarOn == true){
                    ...
                    g2.setColor(new Color(35, 35, 35));         //Contorno da barra
                    g2.fillRect(screenX-1, screenY-16, gp.titleSize+2, 12);

                    g2.setColor(new Color(255, 0, 30));         //Barra de vida
                    g2.fillRect(screenX, screenY-15, (int) hpBarValue, 10);

                    hpBarCounter++;
                    if(hpBarCounter > 600){     //Apos 10 segundos (600 frames), a barra de vida desaparece
                        hpBarCounter = 0;
                        hpBarOn = false;
                    }
                }
